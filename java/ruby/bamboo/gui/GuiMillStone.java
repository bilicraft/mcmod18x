...
public class GuiMillStone extends GuiContainer {
    private static final ResourceLocation RESORCE = new ResourceLocation(Constants.RESOURCED_DOMAIN + "textures/guis/guimillstone.png");
    private TileMillStone tile;

    public GuiMillStone(InventoryPlayer par1InventoryPlayer, TileEntity tileEntity) {
        super(new ContainerMillStone(par1InventoryPlayer, (TileMillStone) tileEntity));
